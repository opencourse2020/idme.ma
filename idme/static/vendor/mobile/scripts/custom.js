...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "Syndicma"; //Local Storage Names for PWA
    ...
    function init_template(){
        ...
        */
        ...
        // Prevent dropdown from closing on click
            var drop_ct = document.getElementsByClassName('dropdown-content')[0];

            drop_ct.addEventListener('click',function(e){
        ...
        // All parent levels require .dropdown-toggle class
            var drop_tgl = document.getElementsByClassName('dropdown-toggle')[0];

            drop_tgl.addEventListener('click',function(e){
        ...
        let plugins = [
          ...
          {
            id: 'chart',
            plug: '../../../static/vendor/mobile/plugins/charts/charts.js',
            call: '../../../static/vendor/mobile/plugins/charts/charts-call-charts.js',
            trigger: '.chart'
          },
          {
            id: 'chart',
            plug: '../../../static/vendor/mobile/plugins/charts/charts.js',
            call: '../../../static/vendor/mobile/plugins/charts/charts-call-wallet.js',
            trigger: '.wallet-chart'
          },
          {
            id: 'chart',
            plug: '../../../static/vendor/mobile/plugins/charts/charts.js',
            call: '../../../static/vendor/mobile/plugins/charts/charts-call-dashboard.js',
            trigger: '.dashboard-chart'
          },
          {
            id: 'graph',
            plug: '../../../static/vendor/mobile/plugins/charts/charts.js',
            call: '../../../static/vendor/mobile/plugins/charts/charts-call-graphs.js',
            trigger: '.graph'
          },
          {
            id: 'count',
            plug: '../../../static/vendor/mobile/plugins/countdown/countdown.js',
            trigger: '.countdown'
          },
          {
            id: 'gallery',
            plug: '../../../static/vendor/mobile/plugins/glightbox/glightbox.js',
            call: '../../../static/vendor/mobile/plugins/glightbox/glightbox-call.js',
            style: '../../../static/vendor/mobile/plugins/glightbox/glightbox.css',
            trigger: '[data-gallery]'
          },
          {
            id: 'gallery-views',
            plug: '../../../static/vendor/mobile/plugins/galleryViews/gallery-views.js',
            trigger: '.gallery-view-controls'
          },
          {
            id: 'filter',
            plug: '../../../static/vendor/mobile/plugins/filterizr/filterizr.js',
            call: '../../../static/vendor/mobile/plugins/filterizr/filterizr-call.js',
            style: '../../../static/vendor/mobile/plugins/filterizr/filterizr.css',
            trigger: '.gallery-filter'
          },
          {
            id: 'embedly',
            plug: '../../../static/vendor/mobile/plugins/embedly/embedly.js',
